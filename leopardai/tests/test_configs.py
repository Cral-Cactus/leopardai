...
class TestConfig(unittest.TestCase):
    ...
    def test_is_rocm_flag(self):
        ...
        os.environ["leopard_BASE_IMAGE_FORCE_ROCM"] = "true"
        reload(config)
        ...
        os.environ["leopard_BASE_IMAGE_FORCE_ROCM"] = "false"
        reload(config)
...
class TestPydanticCompatib(unittest.TestCase):
    def test_compatible_root_model(self):
        from leopardai.config import CompatibleRootModel
    ...
    def test_compatible_field_validator(self):
        from leopardai.config import compatible_field_validator
    ...
    def test_v2only_field_validator(self):
        from leopardai.config import v2only_field_validator, PYDANTIC_MAJOR_VERSION
