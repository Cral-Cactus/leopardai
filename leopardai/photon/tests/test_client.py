...
from leopardai.client import Client, PathTree, local
from leopardai.photon import Photon, handler, StreamingResponse, HTTPException
...
class TestPathTree(unittest.TestCase):
    ...
    def test_path_tree_bool(self):
        from leopardai.client import PathTree
...
class TestClient(unittest.TestCase):
    ...
    def test_client_with_post_and_get_same_name(self):
        ...
        # Tests if run_post and run_get are both registered
        from leopardai.client import _MultipleEndpointWithDefault
