...
from leopardai import config, __version__
from leopardai.cli import lep as cli
from leopardai.cli.photon import _sequentialize_pip_commands
...
class TestPipSequences(unittest.TestCase):
    def test_sequence_correctness(self):
        sequences = [
            ...
            [
                "numpy",
                "git+http://github.com/leopardai/leopardai/",
                "uninstall numpy",
                "scipy",
                "torch",
                "numpy",
        ...
        expected_outputs = [
            ...
            [
                ("install", ["numpy", "git+http://github.com/leopardai/leopardai/"]),
                ("uninstall", ["numpy"]),
...
class TestNoMothershipWorkspace(unittest.TestCase):
    ...
    def test_no_mothership_workspace(self):
        ...
        self.assertIn(
            "https://dashboard.leopard.ai/workspace/emt2tod3/setup", result.output
        )
