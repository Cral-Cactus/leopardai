...
def kv():
    """
    Manage KV stores on the leopard AI cloud.

    The leopard Key-Value store. Every named KV can be considered the equivalent
...
def create(name):
    ...
    console.print(
        ...
        " asynchronous, and may take a few seconds. Use [bold]leopard kv list[/] to"
