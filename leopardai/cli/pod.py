"""
Pod is a module that provides a way to create and manage leopard AI Pods.

A Pod (short for "leopard AI Pod") is a container runtime that allows you to
run interactive sessions on the leopard AI cloud. Think of it as a remote
...
def pod():
    """
    Manages pods on the leopard AI cloud.
