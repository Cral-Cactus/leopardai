...
def queue():
    """
    Manage queues on the leopard AI cloud.

    leopard provides a simple to use message queue for sending messages between
...
def create(name):
    ...
    console.print(
        ...
        " asynchronous, and may take a few seconds. Use [bold]leopard queue list[/]"
