...
from leopardai.config import leopard_RESERVED_ENV_NAMES
...
def secret():
    """
    Manage secrets on the leopard AI cloud.
    ...
    into display output. Secret names starting with `leopard_` or `leopard_` are
...
def create(name, value):
    ...
    for n in name:
        check(
            n not in leopard_RESERVED_ENV_NAMES,
