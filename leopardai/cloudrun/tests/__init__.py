# flake8: noqa
"""
Cloudrun functionality for leopardAI

The cloudrun functionality allows you to create deployments (services) in a more
interactive way. It is a thin wrapper around the leopardAI API.

While conventional use of leopardAI involves creating a photon, and then pushing
