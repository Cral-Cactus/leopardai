...
class Client(object):
    """
    The leopard python client that calls a deployment in a workspace.
    ...
    or if you are running locally,
        client = Client(local())
    or via a full URL if you are managing leopard photons yourself:
        client = Client("https://my-custom-leopard-deployment.com/")
    ...
    def __init__(
        ...
        """
        Initializes a leopard client that calls a deployment in a workspace.
    ...
    def local(port: int = DEFAULT_PORT):
        ...
        purposes, and does not require you to type the local IP address repeatedly.
        This is an alias of leopard.client.local.
    ...
    def _create_post_path(self, path_name: str) -> None:
        ...
        :param name: the name of the path. For example, if it is "https://x.leopard.ai/run", then "run"
    ...
    def _create_get_path(self, path_name: str) -> None:
        ...
        :param name: the name of the path. For example, if it is "https://x.leopard.ai/run",
...
class Workspace(object):
    """
    The leopard python class that holds necessary info to access a workspace.
