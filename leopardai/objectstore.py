"""
leopard's Object store provides a simple way to transmit small files between deployments,
...
class ObjectStoreClientBase(ABC):
    ...
    def put(self, key: str, file_like: Union[IO, str, File]):
        ...
        if isinstance(file_like, File):
            ...
            raise TypeError(
                "file_like must be either a string, a leopard File class object, or "
